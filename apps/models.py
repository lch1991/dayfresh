...
class DfUserGroups(models.Model):
    user = models.ForeignKey(DfUser, models.DO_NOTHING)
    group = models.ForeignKey(AuthGroup, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'df_user_groups'
        unique_together = (('user', 'group'),)


class DfUserUserPermissions(models.Model):
    user = models.ForeignKey(DfUser, models.DO_NOTHING)
    permission = models.ForeignKey(AuthPermission, models.DO_NOTHING)

    class Meta:
        managed = False
        db_table = 'df_user_user_permissions'
        unique_together = (('user', 'permission'),)
